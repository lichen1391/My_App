  ...
  <body>
    ...
    <form id="add_form" method="post">
    	<table cellpadding="1" cellspacing="1" style="margin:10px 30px; color: #333; line-height: 2.2em">
        	...
        	<tr><td align=left>用户类型：</td><td><input type="text" name="role_id" class="easyui-textbox easyui-validatebox" data-options="required:true,validType:'chinese'" style="width:200px;"></td></tr>
    	</table>
    </form>
