  ...
  <body class="login-bg">
    <div class="login-box">
        ...
        <div class="login-main">
			<form action="system/login" class="layui-form" method="post">
				<input name="__RequestVerificationToken" type="hidden" value="">                
				<div class="layui-form-item">
					<label class="login-icon">
						<i class="layui-icon"></i>
					</label>
					<input type="text" name="admin_id" lay-verify="userName" autocomplete="off" placeholder="用户名" class="layui-input">
				</div>
				<div class="layui-form-item">
					<label class="login-icon">
						<i class="layui-icon"></i>
				...
				<div class="layui-form-item" style="display:inline-block;float:left;">
					...
					<input type="text" name="validate" lay-verify="code" autocomplete="off" placeholder="输入验证码" class="layui-input" style="display:inline-block;float:left;width:62%;">
					<div id="validate_code" onclick="refresh_validate_code()"></div>
				</div>
				...
				-->
					<div class="pull-right">
						<button class="layui-btn layui-btn-primary" lay-submit="" lay-filter="login" onclick="return validate_code()">
