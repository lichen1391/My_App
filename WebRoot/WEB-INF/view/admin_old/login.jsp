...
<body style="background-color: #0099FF;">
	...
	<!-- <div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			<div data-src="static/login/images/banner_slide_01.bmp"></div>
			<div data-src="static/login/images/banner_slide_02.jpg"></div>
			<div data-src="static/login/images/banner_slide_03.png"></div>
		</div>
	</div> -->
				...
				$.ajax({
					...
					success: function(data){
						if("success" == data.result){
							...
							$("#loginname").focus();
						}else if("accounterror" == data.result){
							$("#loginname").tips({
								side : 1,
								msg : "用户名不存在",
								bg : '#FF5080',
							...
							$("#code").focus();
						}else if("noactivate" == data.result){
							$("#loginname").tips({
								side : 1,
								msg : "用户未激活",
								bg : '#FF5080',
